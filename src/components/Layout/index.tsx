...
const Layout = ({ children }: { children: ReactNode }) => {
  return (
    <div className="container min-h-screen w-full bg-gradient-to-l from-primary-100 to-secondary-100 overflow-y-hidden">
      ...
      <div className="child-container bg-light min-h-[517px] mt-10 lg:mt-[20px] rounded-t-2xl lg:rounded-tl-[40px] lg:rounded-tr-[0] pt-10 pb-6 overflow-auto px-4 md:px-10 lg:px-10">
