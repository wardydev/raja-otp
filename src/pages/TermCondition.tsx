import { LayoutUnprotectRoutes } from "../components";
    ...
    <LayoutUnprotectRoutes>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5">
          ...
          <li>
            <p className="mb-2">
              Larangan: Nomor yang dibeli di RajaOTP tidak boleh digunakan untuk
              penipuan ataupun tindakan ilegal yang serupa.
            </p>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5">
          <li>
            <p className="mb-2">
              RajaOTP hanya digunakan untuk menerima SMS OTP dari aplikasi yang
              anda pilih saja.
            </p>
          </li>
          <li>
          ...
          <li>
            <p className="mb-2">
              ...
              pertama diterima. Kami memberikan pengembalian dana hanya jika sms
          ...
          <li>
            <p className="mb-2">
              Semua layanan yang ada di RajaOTP untuk applikasi/website official
              sesuai layanan yang dipilih, kami tidak bertanggung jawab jika ada
              kesalahan untuk penggunaan bukan dari applikasi official/resmi
              layanan.
            </p>
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5">
          <li>
            <p className="mb-2">
              Harga yang RajaOTP tawarkan dapat berubah sewaktu-waktu tanpa ada
              pemberitahuan.
            </p>
          </li>
          <li>
          ...
          <li>
            <p className="mb-2">
              ...
              Layanan hanyalah perkiraan saja, karena Server bisa saja mengalami
              Overload.
            </p>
          </li>
        </ul>
